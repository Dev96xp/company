...
<x-app-layout>
    ...
    <section>
        ...
        <div class="w-full mx-auto px-4 sm:px-6 lg:px-64 py-40 bg-cover relative ml-10"
            style="background-image: url('{{ asset('img/home/pexels-daniel-smyth-8865187.jpg') }}') ;background-position:center">


            <div class="w-full md:w-3/4 lg:w-3/4">
                <h1 class="text-white text-8xl py-6" style="font-family: Sche">Best Machining, Inc</h1>
                ...
                <p class="text-white font-bold text-xl mt-2 mb-4" style="font-family: Montserrat">
                    We perform close tolerance machining to provide our customers with products or
                     parts that exceed their expectations of quality.
                </p>
    ...
    <section class="mt-4">
        ...
        <div
            ...
            <article>
                <figure>
                    <a href="#"><img class="rounded-xl lg:h-40 w-full object-cover"
                            src="{{ asset('img/home/pexels-daniel-smyth-8956313.jpg') }}" alt=""></a>
                    ...
                    <a href="#" class="mt-2">
                        <p>CNC, or computer numerical control machining, is a widely used manufacturing process that uses automated,
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-40 w-full object-cover"
                        src="{{ asset('img/home/pexels-pixabay-50691.jpg') }}" alt="">
                    <header class="mt-2">
                        <a href="#">
                    ...
                    <a href="#" class="mt-2">
                        <p>Skilled machinists operate a CNC machine by programming tool paths based on the geometry of the final
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-40 w-full object-cover" src="{{ asset('img/home/pexels-daniel-smyth-8865187.jpg') }}"
                        alt="">
                    <header class="mt-2">
                        <h1 class="text-center text-xl text-gray-700">Applications</h1>
                    </header>
                    <p>CNC machining is widely used across industries. It is common in aerospace, automotive, consumer electronics,
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-40 w-full object-cover" src="{{ asset('img/home/pexels-pixabay-159298.jpg') }}"
                        alt="">
                    <header class="mt-2">
                        <h1 class="text-center text-xl text-gray-700">Materials</h1>
                    </header>
                    <p>Because CNC machining can cut a high variety of fully dense, durable materials like aluminum 5052 and
    ...
    <section class="my-24 mx-auto px-4 sm:px-6 lg:px-64">
        <h1 class="text-center text-3xl text-gray-600">Advantage</h1>
        <p class="text-center text-gray-500 text-xl mb-6">The advantage of working with BEST MACHINING, INC. is the experiance and attitude of our team.
            We understand that other companies have similar capabilities and what will continue
            to make us successful going forward is the commitment to quality and customer service that we have maintained we began in 1977.
        </p>

        {{-- Course Card - Tarjeta --}}

        {{-- NICE - (grid grid-cols-4 gap-x-6 gap-y-8) AGREGA UNA GRID CON CUATRO COLUMNAS --}}
        {{-- NICE 2 - (grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8)  MISMNO GRID CON 4 COLUMNAS PERO RESPONSIVAS --}}

        {{-- 1- Aqui la tarjeta que es un componente de blade se manda llamar
                    2- Al mismo tiempo se envian los datos de la variable $course
                OJO EN COGIDO PHP para lo cual se le ponen 2 puntos (:) --}}
        {{-- <div
    ...
    <section class="mt-24 bg-gray-400 mx-auto px-4 sm:px-6 lg:px-64 py-12">
        <h1 class="text-center text-white text-xl">When you work with our company, your deal directly with us,
            There's no communication loss and there no excuses. Your satisfaction is our goal.</h1>

        <div class="flex justify-center my-4">
            <a href="#"
                class="bg-pink-400 hover:bg-pink-300 text-white font-bold py-2 px-4 rounded">
                Equitment
            </a>
        </div>
    ...
    <section class="mt-24 bg-gray-700 py-12" style="display:none">
        ...
        <div class="flex justify-center my-4">
            <a href="#"
                class="bg-pink-500 hover:bg-pink-300 text-white font-bold py-2 px-4 rounded">
        ...
        <div
            ...
            <article>
                <figure>
                    ...
                    <header class="mt-2">
                        <h1 class="text-center text-xl text-gray-700 font-bold">$50.00 OFF Any damas dress, for 5 o more
                        </h1>
                    </header>
    ...
    <section class="my-4">
        <hr>
        <p class=" text-sm max-w-7xl mx-auto px-4">Best Machining is a Trademark with Copyright 2022 BestMachining Inc. DESIGN
            by Nucleus-Technologies Copyright 2022<a class="text-blue-500 font-bold" href="">Termins and conditions</a>
        </p>
    </section>
...
{{-- <!DOCTYPE html>   TODA LA PAGINA ORIGINAL
